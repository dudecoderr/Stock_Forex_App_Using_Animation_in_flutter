...
class InformationBottomSheetWidget extends StatefulWidget {
  const InformationBottomSheetWidget({Key? key}) : super(key: key);

  @override
  State<InformationBottomSheetWidget> createState() => _InformationBottomSheetWidgetState();
}

class _InformationBottomSheetWidgetState extends State<InformationBottomSheetWidget> with SingleTickerProviderStateMixin {
